...
export default function HomePage(): JSX.Element {
	...
	return (
		<Layout.Default>
			...
			<div className="min-h-screen flex items-center justify-center py-12 select-none">
				<div className="max-w-md sm:max-w-lg md:sm:max-w-2xl lg:sm:max-w-4xl w-full space-y-8 text-center">
					<Animate
						as="h1"
						animation={{
							opacity: [0, 1],
